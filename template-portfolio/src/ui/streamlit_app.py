...
st.caption("Responde dúvidas sobre o livro Pro Git com citação de página.")
...
st.divider()
st.caption(
    "Powered by Gemini + Chroma RAG — corpus: Pro Git (Scott Chacon)"
)
